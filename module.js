var buttonsModule = angular.module('ngKeycodeTracker', [])
    .directive('keycodeTracker', function ($compile, $location, $rootScope) {
        return {
            ...
            link: function (scope, iElement) {
                var trackerText = $compile(
                        '<div id="keycode-tracker" ng-show="showTracker" style="position: fixed; top: 0; left: 0; height: {{height}}px; border: 1px solid red; width: 1px;transform-origin: 0 0;transform: rotateZ(-{{angle}}deg);"></div>' +
